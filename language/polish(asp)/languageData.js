define({
  ...
  "20 SEC AGO" : "20SEK. TEMU",
  "30 SEC AGO" : "30SEK. TEMU",
  "1 MIN AGO" : "1MIN TEMU",
  "0 MIN" : "0 MIN",
  "1 MIN" : "1 MIN",
  "2 MIN" : "2 MIN",
  ...
  "ALARM\nOUTPUT" : "WYJŚCIA\nALARMOWE",
  "ALARM RECORDING" : "NAGRYW. ALARMOWE",
  "ALARM\nRECORDING" : "NAGRYW.\nALARMOWE",
  ...
  "BURNED" : "WYPALONE ",
  "BURNING TYPE" : "TRYB",
  "BURNING" : "ARCHIWIZACJA",
  "__SKIP__" : "__SKIP__",
  "BUZZER OUT" : "BUZZER",
  "BUZZER" : "BUZZER",
  "CAM" : "KAM",
  "CAMERA" : "KAMERA",
  "CAMERA SETUP" : "USTAWIENIE KAMER",
  "CAMERA\nSETUP" : "KONFIGURACJA\nKAMERY",
  ...
  "EDIT" : "EDYTUJ",
  "EMAIL" : "EMAIL",
  "E-MAIL NOTI." : "EMAIL POWIAD.",
  "E-MAIL NOTIFICATION" : "POWIADOM. EMAIL",
  ...
  "MOT" : "RUCH",
  "MOTION" : "RUCH",
  "MOTION COLOR" : "KOLOR STREF DETEKCJI",
  ...
  "RESERVED DATA\nMANAGEMENT" : "REZERWUJ USTAWIENIA\nKONFIGURACJI",
  "RESERVED\nDATA\nMANAGEMENT" : "REZERWUJ\nDANE",
  "RTSP PORT" : "PORT RTSP",
  ...
  "USER" : "UŻYTKOWNIK",
  "USER AUTHORITY" : "UPRAWNIENIA UŻYTKO.",
  ...
  "__SKIP__" : "__SKIP__",
  "__SKIP__" : "__SKIP__",
  "Do you want to upgrade firmware?" : "Chcesz aktualizować firmware?",
  "__SKIP__" : "__SKIP__",
  ...
  "Please input FROM info." : "Proszę wprowadzić parametr OD.",
  "Please input server." : "Proszę wprowadzić nazwę serwera.",
  ...
  "USER NAME" : "NAZWA UZYTKOW.",
  "DIRECTORY" : "KATALOG",
  "FTP TEST" : "TEST FTP",
  "SNAPSHOT NOTI." : "POWIADOM. FOTO.",
  "31 MIN" : "31 MIN",
  "32 MIN" : "32 MIN",
  "33 MIN" : "33 MIN",
  "34 MIN" : "34 MIN",
  ...
  "RECORD OPERATION" : "CZYNNOŚĆ NAGRYW.",
  ...
  "EVENT ACTION VIDEO POPUP" : "POPUP VIDEO",
  "EVENT ACTION BUZZER" : "BUZZER",
  ...
  "SYSTEM GERNERAL INFORMATION" : "OGÓLNE INFO. O SYSTEMIE",
  ...
  "The system data has been saved successfully." : "Dane systemowe zostały zapisane.",
  ...
  "It's unable to support multi session media.\nPlease insert another media." : "Obsługa napędu wielosesyjnego jest niemożliwa.\nWybierz inny napęd.",
  ...
  "It's an invalid owner name." : "Nieprawidłowa nazwa właściciela.",
  ...
  "IN USE" : "W UŻYCIU",
  "__SKIP__" : "__SKIP__",
  "S.M.A.R.T CHECK INTERVAL" : "INTERWAŁ TESTU",
  ...
  "MINIMUM E-MAIL FREQUENCY" : "MINIM. CZĘSTOŚĆ EMAILI",
  "ACTION" : "AKCJA",
  ...
  "TEXT-IN DEVICE SEARCH" : "WYSZUKAJ URZĄDZEŃ WG TEKSTU",
  "HOURS" : "GODZ.",
  "MINUTES" : "MIN.",
  "DAYS" : "DNI",
  "VERIFY INTEGRITY" : "WERYFIKACJI",
  "SET BY" : "USTAWI. PRZEZ",
  "END" : "KONIEC",
  ...
  "WB MODE" : "TRYB WB",
  "MWB MODE" : "TRYB MWB",
  "INDOOR (2800K)" : "WEWNĘTRZNIE (2800K)",
  "OUTDOOR (6500K)" : "ZEWNĘTRZNIE (6500K)",
  ...
  "REALLOCATED SECTORS COUNT" : "LICZ PRZEALOKOWANE SEKTORY",
  "SPIN UP TIME" : "CZAS OBROTU",
  "SPIN RETRY COUNT" : "LICZNIK POWTÓREK OBROTU",
  "START/STOP COUNT" : "START/STOP LICZNIKA",
  "POWER CYCLE COUNT" : "LICZNIK CYKLI WŁĄCZANIA",
  ...
  "LINKED CAMERA CHANNEL" : "KANAŁ POWIĄZANY",
  ...
  "DETAIL INFORMATION" : "INFO. SZCZEGÓŁOWE",
  "FILE NAME" : "NAZWA PLIKU",
  "ARCHIVED AT" : "ZARCHIWIZOWANO PRZY",
  "RESERVED AT" : "ZAREZERWOWANO PRZY",
  ...
  "Recoverying storage is timeout.\nThis system will reboot." : "Przekroczony czas przywracania nosnika.\nSystem zrestartuje się wkrótce.",
  ...
  "Fail to reserve because of too many locked data." : "Rezerwacja nieudana z powodu zbyt dużej ilości rezerwacji.",
  "LOWEST" : "NAJNIŻSZY",
  ...
  "INTERNET" : "INTERNET",
  "BAD SECTOR COUNT" : "LICZNIK BAD-SECTORÓW",
  "SPECIFIC TIME" : "OKREŚLONY CZAS",
  "NO DISK." : "Brak dysku.",
  "S.M.A.R.T. ERROR." : "BŁĄD S.M.A.R.T.",
  "DISK EXHAUST." : "DYSK PRZEPEŁNIONY.",
  "DISK FULL." : "DYSK ZAPEŁNIONY.",
  ...
  "The operation occured an error as a code %d." : "Pojawił się błąd jako kod %d.",
  ...
  "While setting the camera can be restarted.\nDo you want to continue?" : "Podczas ustawiania kamery może być restart.\nCzy chcesz kontynuować?",
  ...
  "Camera type has been changed.\nThe system will be reboot soon." : "Rodzaj kamery został zmieniony. \nSystem będzie zresetowany wkrótce.",
  ...
  "It has been failed for testing of connection\nto the FTP server." : "To była niudana próba połączenia\ndo serwera FTP.",
  "It has been failed for testing of the authentication." : "To była nieudana próba autoryzacji.",
  "It has been failed for testing of reading and writing." : "To była nieudana próba odczytu i zapisu.",
  "The available FPS is over." : "Dostęp FPS jest skończony.",
  ...
  "AC POWER FREQUENCY" : "CZĘSTOTLIWOŚĆ NAPIĘCIA ZMIENNEGO",
  "The configuration HDSDI OUTPUT MODE is applied as you use HDSDI output only." : "Wyjście HD-SDI jest konfigurowane tylko wtedy, gdy wyjścia HD-SDI jest użytkowane.",
  "Reboot after set the HDSDI switch on the rear panel, if you want to display HDSDI output." : " n Zrestartuj po ustawieniu przełącznika HD-SDI na tylnym panelu, jeśli chcesz wyświetlić wyjście HD-SDI.",
  "__SKIP__" : "__SKIP__",
  "RECORD STATUS" : "STATUS NAGRANIA.",
  "SET" : "USTAW",
  "PTZ SCAN" : "PTZ SCAN",
  "COVERT DISPLAY SETTING" : "WYŚWIETLANE USTAWIENIA",
  "DWELL" : "DWELL",
  "SCAN / TOUR" : "SCAN / TOUR",
  "Password expiration day is %d remained.\nChange your password." : "Okres ważności hasła wynosi %d .\nZmień hasło.",
  "Password expiration day was passed.\nChange your password." : "Okres ważności hasła wygasł.\nZmień hasło.",
  "Don't show this message for a day." : "Nie pokazuj tej informacji w ciągu dnia.",
  "%d SEC" : "%d SEK.",
  "AUDIO SUPPORT" : "OBSŁUGA DŹWIĘKU",
  "SNAPSHOT SUPPORT" : "OBSŁUGA ZRZUTÓW / ZDJĘĆ",
  "ENHANCED PASSWORD RULE" : "HASŁO SZYFROWANE",
  "PASSWORD CHECK WHEN SEARCH/BACKUP" : "SPRAWDZANIE HASŁA DLA PRZESZUKIWANIA / KOPIOWANIA",
  "RAW BACKUP WITH ENCRYPTION KEY" : "KOPIA RAW  Z KLUCZEM SZYFROWYM",
  "RECORD STATUS" : "STATUS NAGRYWANIA",
  "SWITCH OPERATION MODE" : "TRYB OPERACJI PRZEŁĄCZNIKA ",
  "ERASE VIDEO" : "WYMAZANIE VIDEO",
  "ERASE" : "WYMAZANIE",
  "ENCRYPTION" : "SZYFROWANIE",
  "RTSP ENCRYPTION ENABLE" : "DOSTĘPNE SZYFROWANIE RTSP ",
  "RTSP ENCRYPTION METHOD" : "METODA szyfrowania RTSP",
  "HTTPS ENABLE" : "HTTPS włączony",
  "IP FILTER ENABLE" : "IP FILTER DOSTĘPNY",
  "IP FILTER RULE" : "ZASADY FILTRA IP",
  "ALLOW LIST" : "listy dozwolonych",
  "DENY LIST" : "ODMOWA LIST",
  "IP FILTER" : "IP FILTER",
  "NEW PASSWORD" : "NOWE HASŁO",
  "CONFIRM NEW PASSWORD" : "POTWIERDŹ NOWE HASŁO",
  "PASSWORD CHECK" : "SPRAWDZANIE HASŁA",
  "The data is erased successfully." : "Dane zostały wymazane.",
  "Audio configuration has been reset.\nPlease check it" : "Konfiguracja Audio zostaje zresetowana .\nProszę sprawdzić.",
  "Snapshot configuration has been reset.\nPlease check it" : "Konfiguracja zapisu zdjęcia zostaje zresetowana.\nProszę sprawdzić.",
  "Part of the data is erased." : "Część danych została wymazana.",
  "WHITE BALANCE" : "BALANS BIELI",
  "IMAGE SETTINGS" : "USTAWIENIA OBRAZU",
  "EXPOSURE" : "MIGAWKA",
  "DIRECT CONFIGURE" : "KONFIGURACJA BEZPOŚREDNIA",
  "HOME" : "HOME",
  "WIDE DYNAMIC RANGE" : "SZEROKI ZAKRES DYNAMIKI",
  "WIDE DYNAMIC MODE" : "TRYB ZAKRESU DYNAMIKI",
  "DAY / NIGHT" : "DZIEŃ / NOC",
  ...
  "EXPOSURE TIME" : "CZAS MIGAWKI",
  "COPY SETTINGS TO" : "SKOPIUJ USTAWIENIA DO ",
  "If you press 'START' button, you can configure the IP cameras directly by the web access." : "Po naciśnięciu przycisku 'START', dostępna jest bezpośrednia konfiguracja kamer Ip z poziomu przegladarki.",
  "Warning : In this mode, the video recording will be stopped automatically." : "Uwaga! W tym trybie zapis video zostanie zatrzymany automatycznie.",
  "LEVEL" : "POZIOM",
  ...
  "You can configure the IP cameras directly by the web access." : "Możliwa konfiguracja kamer IP bezpośrednio z poziomu przeglądarki.",
  "- Video recording has been stopped automatically -" : "- Rejestracja Video zostanie zatrzymana automatycznie -",
  "INCLUDE SNAPSHOT IMAGE" : "ZAWIERA ZRZUT OBRAZU",
  "Too weak" : "Niewystarczający.",
  "REMOTE CONTROLLER BEEP" : "SYGNAŁ KONTROLERA ZDALNEGO",
  "AUTO PORT FORWARDING" : "AUTOMATYCZNE PRZEKIEROWANIE PORTU",
  "IR CUT FILTER" : "IR CUT FILTER",
  "DNN TOGGLE" : "PRZEŁĄCZNIK DNN",
  "DAY(COLOR) / NIGHT(BW)" : "DZIENNY(KOLOR) / NOC (CZARNO-BIAŁY)",
  "SHOWN AS" : "POKAŻ JAKO",
  "CONTINUOUS RECORD" : "ZAPIS KONTYNUOWANY",
  "HTTP AUTHENTICATION METHOD" : "IDENTYFIKACJI HTTP",
  "This monitor does not support 1080p resolution.\nIt is recommended that you use a 1080p monitor for optimal display.\n(Current screen Resolution : %s Hz)" : "Monitor nie obsługuje rozdzielczości 1080p.\nZaleca się użycie monitora obsługującego rozdzielczość1080p.\n(Aktualna rozdzielczość ekranu: %s Hz)",
  "MIN BLOCK" : "MIN. ILOŚĆ BLOKÓW",
  "HD RECORDING DATE PRIORITY" : "DŁUŻSZY CZAS LECZ NIŻSZA JAKOŚĆ",
  "HD IMAGE QUALITY PRIORITY" : "WYSOKA JAKOŚĆ LECZ KRÓTSZY CZAS",
  "You can't use passwords that contain your id." : "Nie można używać hasła identycznego z ID.",
  "Please retry after 30 sec." : "Ponowna próba po 30 sec.",
  "DDNS connection test is success." : "Test połączenia DDNS zakończony sukcesem",
  "DDNS connection test is failed." : "Test połączenia DDNS niepoprawny.",
  "The previously selected area will be deselected.\nDo you want to continue?" : "Wcześniej zaznaczony obszar zostaje odznaczony.\nCzy chcesz kontynuować?",
  "The same user ID already exists.\nPlease input another user ID." : "Nazwa użytkownika już istnieje.\nWprowadź inną nazwę użytkownika.",
  "If you want to set the time interval, drag the mouse to the time table at the top of the screen and a recording information setting window should appear." : "W celu oznaczenia interwału czasu, zakreśl myszą dany zakres na osi czasu po czym okno informacji nagrywania zostanie wyświetlone.",
  "In the recording information settings window, you can set the desired resolution and quality, FPS, audio recording, and whether to save or not." : "W oknie informacyjnym dot. rejestracji , możliwe jest ustawienie parametrów rozdzielczości, jakości, Liczny Klatek na Sekundę, nagrywania audio, oraz decyzji o nagrywaniu lub zaniechaniu nagrywania.",
  "If there is a different setting value, the time table will be displayed in a different color." : "Jeżeli wprowadzono inne wartości ustawień, tabela czasu zostanie wyświetlona w innym kolorze.",
  "If you hover the mouse pointer over the top of the time table, the corresponding time zone information will be displayed for the recording settings." : "Jeżeli znacznik myszy zostanie wysunięty powyżej zakresu tabeli czasu, informacje dot. strefy czasu zostaną wyświetlane w ustawieniach nagrywania.",
  "A password must satisfy the following rules:" : "Hasło musi spełniać następujące zasady:",
  "Must be greater than 8 characters and less than 16 characters long." : "Długość hasła musi mieścić się w przedziale więcej niż 8 a mniej niż 16 znaków.",
  "Must use more than 3 categories among the English capital letters, English lowercase letters, special characters or Numerics." : "Można wykorzystywać duże litery, małe litery, znaki specjalne oraz cyfry.",
  "The same characters cannot be repeated more than 3 times." : "Ten sam ciąg znaków nie  może być powtórzony więcej niż trzy razy.",
  "You cannot use more than three sequential numbers or letters." : "Nie można użyć sekwencji więcej niż trzy cyfry lub litery.",
  "The corresponding ID cannot be used as part of the password." : "Identyfikator ID nie może być cześcią hasła.",
  ...
  "HELP" : "POMOC",
  "STOP SYSTEM" : "ZATRZYMANIE SYSTEMU",
  "REBOOT SYSTEM" : "RESTART SYSTEMU",
  "If you want to upgrade the IP camera,\nyou must stop the system." : "Jeżeli chcesz aktualizować oprogramowanie kamer IP,\nmusisz zatrzymać system.",
  "Please wait to stop the system." : "Proszę czekać do chwili zatrzymania systemu.",
  "The system has been stopped.\nYou may upgrade the IP camera." : "System zostanie zatrzymany.\nWymagana aktualizacja oprogramowania kamery IP.",
  "Reboot the system after upgrade." : "Zrestartuj system po aktualizacji oprogramowania.",
  "Change the mode of schedule in operation mode page to change hourly, daily setup." : "Zmień tryb okresu w zakładce ustawień w celu dokonania zmian godzin i dni.",
  "Do you want to initialize the camera connected to NVR?" : "Czy chcesz inicjalizacji podłączonej kamery do rejestratora NVR?",
  "It starts to upgrade via network remotely." : "Aktualizacja oprogramowania zostanie uruchomiona zdalnie.",
  "If no action, system upgrade within %d sec." : "Przy bezczynności aktualizacja oprogramowania zostanie uruchomiona za %d sec.",
  "RENEW" : "RENEW",
  "It can be failed to register as %d port have been used in other device." : "Przy rejestracji wystąpi błąd %d jeżeli pod port zostanie podłączone inne urządzenie.",
  "There is no input." : "Brak sygnału wejścia.",
  "There is no input.\nDo you want to continue?" : "Brak sygnału wejścia.\nCzy chcesz kontynuować?",
  "PASSWORD EXPIRATION NOTICE" : "WAŻNOŚĆ HASŁA ",
  "Don't show this message for a day." : "Nie pokazuj tej informacji w ciągu dnia.",
  "Password expiration day is %d remained.\nChange your password." : "Ważność hasła wygaśnie za %d dni.\nZmień hasło.",
  "Password expiration day was passed.\nChange your password." : "Okres ważności hasła wygasł.\nZmień hasło.",
  "CURRENT FW VERSION" : "BIEŻĄCA WERSJA OPROGRAMOWANIA",
  "NEW FW VERSION" : "NOWA WERSJA OPROGRAMOWANIA",
  "The new firmware has been released." : "Nowe oprogramowanie zostało dopuszczone do użycia.",
  "Do you want to upgrade firmware? [Recommended]" : "Czy chcesz aktualizować oprogramowanie? [Zalecane]",
  "Do you want to upgrade firmware?" : "Czy chcesz aktualizować oprogramowanie?",
  "RELEASE NOTE" : "PRZEKAZYWANA INFORMACJA",
  "IP Address (Internal) :" : "IP Address (Internal) :",
  "IP Address (External) :" : "IP Address (Zewnętrzny) :",
  "PRESET EDIT" : "PRZEJDŹ DO EDYCJI",
  "Please check the time of archiving section (from, to)" : "Proszę sprawdzić czas archiwizowania zapisów (od /do)",
  "There is no selected channel." : "Nie wybrano kanału.",
  "There is no data." : "Brak zapisanych informacji.",
  "RTSP SERVICE" : "USŁUGI RTSP",
  "Erased range : (%s)" : "Zakres wymazywania : (%s)",
  "CONNECTING..." : "Łączenie...",
  "UNKNOWN DEVICE" : "NIEROZPOZNAWALNE URZĄDZENIE",
  "UNSUPPORTED CAMERA" : "KAMERA NIEOBSŁUGIWANA",
  "CONNECTION FAIL" : "BŁĄD POŁĄCZENIA",
  "LOGIN FAIL" : "BŁĄD LOGOWANIA",
  "CONFIGURATION FAIL" : "BŁĄD KONFIGURACJI",
  "OKERASE" : "OK.",
  "FTP NOTIFICATION" : "NOTYFIKACJA FTP",
  "FTP SERVER" : "FTP SERVER",
  "INCLUDE WEBRA LINK" : "ZAWIERA WEBRA LINK",
  "MINIMUM FREQUENCY" : "MINIMALNA CZĘSTOTLIWOŚĆ",
  "Bitrate or frame rate can drop to 15FPS during SD recording." : "Podczas nagrywania na karcie SD wartość bitrate lub frame rate powinna wynosić 15FPS.",
  "ENABLE ADAPTIVE STREAMING CONTROL FOR REMOTE CLIENTS." : "DOSTĘPNA ADAPTACYJNA KONTROLA STRYMINGU DLA KLIENTÓW ZDALNYCH.",
  "Adaptive streaming control" : "Adaptacyjna kontrola stymingu.",
  ...
  "__SKIP__" : "__SKIP__",
  "When using OVERWRITE disk write mode, it may not be possible to play a Web-Link\nafter a long period of time has elapsed due to overwrite." : "Używając trybu NADPISYWANIA dysku, może nie być możliwe odtwarzanie poprzez Web-Link\n po dłuższym czasie następuje powrót do trybu nadpisywania danych.",
  "When set to 0 FPS, it will not record and Live View cannot be seen on WEB Viewer.\nDo you want to continue?" : "Przyjmując wartość 0 FPS, nagrywanie oraz podgląd na żywo w przeglądarki sieciowej nie będzie możliwy.\n Czy chcesz kontynuować ?",
  ...
  "Please retry after 15 sec." : "Ponowna próba po 15 sec.",
  ...
  "NOV" : "NOV",
  "DEC" : "DEC",
  "* To add a port USB to Serial Device connection is required." : "* Aby dodać port poprzez konwerter USB-RS234, wymagane jest jego uprzednie podłączenie.",
  ...
  "Must be greater than 9 characters and less than 16 characters long." : "Długość hasła musi mieścić się w przedziale więcej niż 9 a mniej niż 16 znaków.",
  ...
  "Please check the E-mail." : "Sprawdź adres E-MAIL.",
  ...
  "DVR Backup is being configured by local administrator.! " : "Backup jest konfigurowany przez lokalnego Administratora!",
  ...
  "Browser Not Support!" : "Przeglądarka nie obsługuje!",
  ...
  "N/C" : "N/C",
  "CH" : "KAM",
  "NETWORK F/W UPGRADE" : "AKTUALIZACJA OPROGRAMOWANIA POPRZEZ SIEĆ",
  "F/W LOCATION" : "LOKALIZACJA OPROGRAMOWANIA",
  "Verifed 'F/W Location' field is required." : "Wymagana weryfikacja 'lokalizacji oprogramowania'",
  "F/W Location changed. Verify again." : "Lokalizacja oprogramowania zmieniona. Zweryfikuj ponownie.",
  "Request update to NVR." : "Prośba o aktualizacje oprogramowania Rejestratora NVR.",
  "F/W upgrade canceled." : "F/W aktualizacja przerwana.",
  "F/W Location field error." : "Błąd pola Lokalizacji Oprogramowania.",
  "Verifying." : "Weryfikacja",
  "Verify Success!" : "Weryfikacja prawidłowa!",
  "Verify Fail!" : "Błąd weryfikacji !",
  "There is No File in URL!" : "Brak pliku w URL!",
  "Network request Fail!" : "Błąd połaczenia sieciowego!",
  "F/W is Invalid!" : "Oprogramowanie jest niepoprawne!",
  "Verifing by another user!" : "Weryfikacja przez innego użytkownika!",
  "Upgrade Success!" : "Aktualizacja zakończona Sukcesem!",
  "Requesting upgrade" : "Wymagana aktualizacja.",
  "F/W Upgrading." : "F/W Aktualizacja oprogramowania.",
  "F/W Update Applied." : "F/W Aktualizacja oprogramowania zastosowana.",
  "NVR is not live mode." : "Rejestrator NVR nie jest w trybie LIVE.",
  "F/W Upgrade rejected." : "F/W Aktualizacja oprogramowania odrzucona.",
  "F/W Upgrade error." : "F/W bląd aktualizacji oprogramowania.",
  "Upgrading by another user!" : "Aktualizacja oprogramowania przez innego użytkownika !",
  "NVR will be restart.." : "System rejestratora NVR zostanie zrestartowany..",
  "NVR restarting.. remain" : "Restart systemu rejestratora NVR.. Proszę czekać.",
  "F/W upgrade finished." : "F/W aktualizacja zakończona.",
  "Password length must be 8 - 16 characters." : "Długość hasła musi być w przedziale 8-16 znaków.",
  "Password must include at least two types among upper-,lowercase alphabetic, numeric, and special character." : "Hasło musi składać się z nie mniej niż dwa małych liter, cyfr lub znaków specjalnych.",
  "Password cannot include the USER's LOGIN ID." : "Hasło nie może zawierać nazwy użtkownika i ID.",
  "Password cannot include the sequence of three or more alphanumeric." : "Hasło musi zawierać więcej niż trzy litery lub cyfry.",
  "Password cannot include the repetitive of three or more character." : "Hasło nie może zawierać powtarzających się trzech lub więcej znaków.",
  "Password cannot include invalid characters." : "Hasło nie zawiera wymaganych znaków.",
  "6 SEC" : "6 SEK.",
  "7 SEC" : "7 SEK.",
  "8 SEC" : "8 SEK.",
  "9 SEC" : "9 SEK.",
  "DOWNLOAD BACKUP PLAYER" : "ZAPISZ ODTWARZACZ NAGRANIA",
  "CONFIRM PASSWORD" : "POTWIERDŹ HASŁO",
  "Please input valid user name." : "Proszę wprowadzić poprawną nazwę użytkownika.",
  "Password doesn't match confirmation." : "Nieprawidłowe hasło.",
  "DVR FW Update is being configured by other Web Remote Agent!" : "Aktualizacja oprogramowania w DVR zostanei przeprowadzone przez Web Remote Agent!",
  ...
  "Request update to DVR." : "Prośba o aktualizacje oprogramowania Rejestratora DVR.",
  "DVR is not live mode." : "Rejestrator DVR nie jest w trybie LIVE.",
  "DVR will be restart.." : "System rejestratora DVR zostanie zrestartowany..",
  "DVR restarting.. remain" : "Restart systemu rejestratora DVR.. Proszę czekać.",
