...
var SCMMSG = {
  ...
  // 'INFY_NFNOTIFY_MIN' : 0x11A0,
  // 'INFY_NFNOTIFY_MAX' : 0x11FF,

  // 0x11A0
  'INFY_CAM_TITLE_NOTIFY'             : 0x11A0,
  'INFY_NOVIDEO_NOTIFY'               : 0x11A1,
  'INFY_NET_NOTIFY'                   : 0x11A2,
  'INFY_ENC_NOTIFY'                   : 0x11A3,
  'INFY_DISK_USAGE_NOTIFY'            : 0x11A4,
  'INFY_DISK_FULL_NOTIFY'             : 0x11A5,
  'INFY_DISK_OW_NOTIFY'               : 0x11A6,
  'INFY_SYSDB_CHANGE_NOTIFY'          : 0x11A7,
  'INFY_NETDB_CHANGE_NOTIFY'          : 0x11A8,
  'INFY_AUDDB_CHANGE_NOTIFY'          : 0x11A9,
  'INFY_DSKDB_CHANGE_NOTIFY'          : 0x11AA,
  'INFY_CAMDB_CHANGE_NOTIFY'          : 0x11AB,
  'INFY_USRDB_CHANGE_NOTIFY'          : 0x11AC,
  'INFY_ALMDB_CHANGE_NOTIFY'          : 0x11AD,
  'INFY_ACTDB_CHANGE_NOTIFY'          : 0x11AE,
  'INFY_DSPDB_CHANGE_NOTIFY'          : 0x11AF,

  // 0x11B0
  'INFY_RECDB_CHANGE_NOTIFY'          : 0x11B0,
  'INFY_COVERT_NOTIFY'                : 0x11B1,
  'INFY_SMART_ERROR_NOTIFY'           : 0x11B2,
  'INFY_ANALOG_REC_NOTIFY'            : 0x11B3,
  'INFY_IPCAM_REC_NOTIFY'             : 0x11B4,
  'INFY_VLOSS_NOTIFY'                 : 0x11B5,
  'INFY_SENSOR_NOTIFY'                : 0x11B6,
  'INFY_MOTION_NOTIFY'                : 0x11B7,
  'INFY_ALARM_NOTIFY'                 : 0x11B8,
  'INFY_PND_NOTIFY'                   : 0x11B9,
  'INFY_PND_RATE_NOTIFY'              : 0x11BA,
  'INFY_PND_HUB_NOTIFY'               : 0x11BB,
  'INFY_WAN_NOTIFY'                   : 0x11BC,
  'INFY_DDNS_NOTIFY'                  : 0x11BD,
  'INFY_WRITEFAIL_NOTIFY'             : 0x11BE,
  'INFY_EXHAUST_NOTIFY'               : 0x11BF,

  // 0x11C0
  'INFY_NODISK_NOTIFY'                : 0x11C0,
  'INFY_SMART_WARN_NOTIFY'            : 0x11C1,
  'INFY_SYSFAN_NOTIFY'                : 0x11C2,
  'INFY_TEMPERATURE_NOTIFY'           : 0x11C3,
  'INFY_POE_NOTIFY'                   : 0x11C4,
  'INFY_POE_HUB_NOTIFY'               : 0x11C5,
  'INFY_POE_PORT_NOTIFY'              : 0x11C6, 
  'INFY_DVRLOGINFAIL_NOTIFY'          : 0x11C7,
  'INFY_NETLOGINFAIL_NOTIFY'          : 0x11C8,
  'INFY_NET_RXTX'                     : 0x11C9,
  'INFY_AUDIOCH_NOTIFY'               : 0x11CA,
  'INFY_MICOUT_NOTIFY'                : 0x11CB,
  'INFY_BUZZER_NOTIFY'                : 0x11CC,
  'INFY_IP_CHANGED_NOTIFY'            : 0x11CD,
  'INFY_IPCAM_INSTALL_NOTIFY'         : 0x11CE,
  'INFY_VCA_EVENT_NOTIFY'             : 0x11CF,

  // 0x10D0
  'INFY_VCA_TRACKINFO_NOTIFY'         : 0x11D0,
  'INFY_VCA_COUNTER_NOTIFY'           : 0x11D1,
  'INFY_VCA_META_DATA_NOTIFY'         : 0x11D2,
  'INFY_VCA_MODULAR_EVENT'            : 0x11D3,
  ...
  'IREQ_SCM_CONFIRM_FWUP_BY_WEB'      : 0x2021,
  ...
  'IRPL_SCM_CONFIRM_FWUP_BY_WEB'      :0x4020,
...
Scmevt.prototype = {
  ...
  // Public Method
  Start : function (flag_async) {
    var me = this;
    me.is_active = true;
    var intervalFunc = function() {
      me._AjaxCall(me, flag_async);
    };
      ...
      if( this._callbackList[ str_msgid ] != undefined) {
        ...
        for (var j = 0 ; j < callbackLength ; j += 1) {
          //if (typeof this._callbackList[msgid][j] == 'function') {
            ...
            //this._callbackList[msgid][j].call(undefined, log['param_' + i]);
            this._callbackList[str_msgid][j].call(undefined, log['param_'+i], log['data_'+i]);
          }
        }
      }
    }
  ...
  _AjaxSuccess : function(response) {
    ...
    var log = encode_to_array(response);
    if (this._debug != undefined) {
      this._PrintLog(log);
    }

    this._CallCallback(log);
    this.currIndex = log['index_' + (parseInt(log['count']) - 1)];
    return true;
  },

  _AjaxCall : function (me, flag_async) {
    var action;
...
function CheckJquery() {
  if(typeof jQuery != 'undefined') {
    ...
    alert('Scmevt module nees JQuery');
  }
}
