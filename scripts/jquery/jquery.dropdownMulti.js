...
$.widget("itx.multiselect", {
    ...
    _create: function(){
        ...
        var classChkContainer;
        
        if( o.horizontal ) {
            classChkContainer = 'ui-multiselect-horizontal';
            o.height = null;
        } else {
            classChkContainer = 'ui-multiselect-checkboxes';
        }
        ...
        var 
            button = (this.button = $('<button type="button"><span class="ui-icon ui-icon-triangle-1-s"></span></button>'))
                ...
                .addClass( o.classes )
                .prop({ 'title':el.prop('title'), 'aria-haspopup':true, 'tabIndex':el.prop('tabIndex') })
                .insertAfter( el ),
            ...
            checkboxContainer = (this.checkboxContainer = $('<ul />'))
                .addClass( classChkContainer + ' ui-helper-reset')
                .appendTo( menu );
    ...
    refresh: function( init ){
        var el = this.element,
            ...
            optgroups = [],
            html = [],
            id = el.prop('id') || multiselectID++; // unique ID for the label & option tags
    ...
    _setButtonWidth: function(){
        var pwidth = this.element.parent().outerWidth();
